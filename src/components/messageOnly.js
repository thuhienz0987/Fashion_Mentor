        ...
        <Modal transparent visible={props.visible}>
            <View style={styles.background}>
                <View style={styles.noticeBox}>
                    <UnderLine text={props.title} textStyle={[styles.titleText, props.title === "Error" && {color: color.RedSolid, opacity: 0.7}]} style={{color: props.title === "Error"?color.RedSolid:color.Black}} lineColor={{backgroundColor: props.title === "Error"?color.RedSolid:color.Black}}></UnderLine>
                    <View style={styles.noticeMessage}>
                        <View style={{width: '100%', height: '65%', justifyContent: 'center', marginTop: scale(-20)}}>
                            <Text style={[styles.messageText,props.fail?{color: color.RedSolid}: null]} numberOfLines={5}>
                                {props.message}
                            </Text>
                        </View>
                        <TouchableOpacity
